...
if __name__ == '__main__':
    file_path = os.path.join(os.getcwd(), "received_audio.wav")
    api = RequestApi(appid=os.getenv("XUNFEI_APP_ID"), secret_key=os.getenv("XUNFEI_API_KEY"), upload_file_path=file_path)
    api.all_api_request()
